    ...
    public void run(String... args) {
        ...
        if (skillRepository.count() == 0) {
            skillRepository.saveAll(List.of(
                    ...
                    Skill.builder().name("Angular 17/18").type("tech&tools").build(),
                    Skill.builder().name("React").type("tech&tools").build(),
                    Skill.builder().name("TypeScript").type("tech&tools").build(),
